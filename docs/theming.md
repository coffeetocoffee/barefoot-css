...
| `--bf-font-cjk` | `system-ui, "Yu Gothic", "Hiragino Kaku Gothic ProN", "Noto Sans CJK JP", sans-serif` | CJK script font |
| `--bf-font-arabic` | `system-ui, "Noto Naskh Arabic", "Amiri", sans-serif` | Arabic script font |
| `--bf-line-height` | `1.6` | body leading |
| `--bf-line-height-cjk` | `1.75` | CJK script leading |
| `--bf-line-height-arabic` | `1.85` | connected-script leading |
...
| `--bf-danger-subtle` | `color-mix(in oklab, var(--bf-danger), transparent 88%)` | very light danger tint |
